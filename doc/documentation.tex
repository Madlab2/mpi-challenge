...
\section{Einleitung}
\include{subsection/Einleitung.tex}
\section{Grundlagen}
\include{subsection/MergeSort.tex}
\subsection{Merge Sort}
 \subsection{subsection/Message Passing Interface}
 \subsection{Cloud Computing}
\section{Umsetzung}
\include{subsection/Test.tex}
\subsection{Parallelisierung}
\section{Ergebnis}
\subsection{subsection/Optimierung}
\include{subsection/Auswertung.tex}
\section{subsection/Fazit}
...
\bibitem{b1} Dietmar Fey "Grid-Computing: Eine Basistechnologie für Computational Science", Springer Verlag Heidelberg, Berlin, Seite 99-117 ,2010
\end{thebibliography}
